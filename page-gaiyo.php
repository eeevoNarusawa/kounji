...
<div class="c-page-wrap">
  <div class="c-page--min-width">
    <div class="p-gaiyo-ttl u-font-serif u-fade-up">光運寺について</div>
    <div class="p-gaiyo-subttl u-font-serif u-fade-up">～より豊かに より幸せに～</div>
    <section class="p-gaiyo-conts u-fade-up">
      <div class="p-gaiyo-conts--copy u-font-serif u-fade-up">
        700年前に一人の僧侶が<br class="sp">仏道を求め<br class="pc">この四日市の地に<br class="sp">念仏道場を建てたのが、<br>光運寺の起源です。
      </div>
      <div class="p-gaiyo-conts--text u-fade-up">
        光運寺は仏教に出会えた奇跡に感謝し、<br>
        仏様のお導きよって、より豊かにより幸せに<br>
        共に生きる人が集うお寺です。
      </div>
    </section>

    <section class="p-gaiyo-overview">
      <div class="p-gaiyo-ttl u-font-serif u-fade-up">光運寺概要</div>
      <table class="p-gaiyo-overview--table u-fade-up">
        <tr>
          <th>正式名称</th><td class="colon">:</td><td>三重山 大知院 光運寺</td>
        </tr>
        <tr>
          <th>宗　派</th><td class="colon">:</td><td>浄土宗</td>
        </tr>
        <tr>
          <th>御本尊</th><td class="colon">:</td><td>阿弥陀如来</td>
        </tr>
        <tr>
          <th>開　創</th><td class="colon">:</td><td>正安3年2月(1301年)</td>
        </tr>
        <tr>
          <th>宗　祖</th><td class="colon">:</td><td>法然上人</td>
        </tr>
      </table>
    </section>
  ...
  <div class="c-page--min-width">
    <section class="p-gaiyo-history">
      <div class="p-gaiyo-history--ttl u-font-serif u-fade-up">光運寺の歴史</div>
      <table class="p-gaiyo-history--table">
        <tr class="u-fade-up">
          <th>1301年</th><td>明観上人、念仏道場として尊乗寺を創建</td>
        </tr>
        <tr class="u-fade-up">
          <th>1472年</th><td>源誉上人、一万日の念仏を修して伽藍を再建</td>
        </tr>
        <tr class="u-fade-up">
          <th>1872年</th><td>四日市学校（第一尋常小学校・現中部西小学校）が光運寺内に創設される</td>
        </tr>
        <tr class="u-fade-up">
          <th>1916年</th><td>四日市仏教寺院有志により、四日市仏教保育院創設</td>
        </tr>
        <tr class="u-fade-up">
          <th>1945年</th><td>四日市大空襲により全ての伽藍が消失</td>
        </tr>
        <tr class="u-fade-up">
          <th>1951年</th><td>四日市仏教保育院を四日市市へ移管</td>
        </tr>
        <tr class="u-fade-up">
          <th>1966年</th><td>功誉上人、本尊阿弥陀如来を造立</td>
        </tr>
        <tr class="u-fade-up">
    ...
    <section class="p-gaiyo-address">
      <div class="p-gaiyo-address--ttl u-font-serif u-fade-up">所在地</div>
      <div class="p-gaiyo-address--text u-fade-up">〒510-0082 三重県四日市市中部3-12</div>
      <div class="p-gaiyo-address--maps u-fade-up">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6709.920776145629!2d136.6215976776399!3d34.96782452779044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60038ee4b79bf1b9%3A0xc7619b910e953bc0!2z5YWJ6YGL5a-6!5e0!3m2!1sja!2sjp!4v1592246681426!5m2!1sja!2sjp" width="1190" height="500" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
      </div>
      <div class="p-gaiyo-address--maps__link u-fade-up"><a href="https://goo.gl/maps/qSqfzkxncvgYZ1xt8" target="_blank">大きな地図で見る</a></div>
    </section>
  </div><?/* /.c-page--min-width */?>
</div><?/* /.c-page-wrap */?>
<?php get_footer(); ?>
